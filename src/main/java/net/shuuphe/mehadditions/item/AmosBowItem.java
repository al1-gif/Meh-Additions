...
public class AmosBowItem extends BowItem {
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        if (!user.isCreative() && !findRune(user, ModItems.LIGHTNING_STONE)) return ActionResult.FAIL;
    ...
    public boolean onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!player.isCreative() && !consumeRune(player, ModItems.LIGHTNING_STONE, reg)) return false;
